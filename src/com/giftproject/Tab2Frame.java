...
public class Tab2Frame extends JPanel {
	...
	public Tab2Frame() {
		...
		setLayout(new MigLayout("", "[138.00,grow][grow]", "[][][][grow][][grow][][][center][][][][]"));
		...
		table_correct.setModel(new DefaultTableModel(
		...
		table_wrong.setModel(new DefaultTableModel(new Object[][] { { null, null,
				...
				btnDelete.addMouseListener(new MouseAdapter() {
					...
					public void mouseClicked(MouseEvent e) {
						...
						btnAdd.addMouseListener(new MouseAdapter() {
							@Override
							public void mouseClicked(MouseEvent e) {
								DefaultTableModel model = (DefaultTableModel) table_wrong.getModel();
	...
	public void removeSelectedFromTable(JTable from) {
		DefaultTableModel model = (DefaultTableModel) this.table_wrong.getModel();
